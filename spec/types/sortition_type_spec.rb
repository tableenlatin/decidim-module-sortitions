  ...
  module Sortitions
    describe SortitionType, type: :graphql do
      ...
      context "when the sortition is cancelled" do
        ...
        shared_examples "unauthorized Sortition" do
          it "raises Decidim::Api::Errors::UnauthorizedObjectError" do
            expect { response }.to raise_error(
              Decidim::Api::Errors::UnauthorizedObjectError,
              "You cannot view or edit this Sortition because you do not have permissions"
            )
          end
        end
        ...
        context "when participatory space is private" do
          ...
          it_behaves_like "unauthorized Sortition"
        end

        context "when participatory space is private but transparent" do
          let(:participatory_space) { create(:assembly, :restricted, :transparent, organization: current_organization) }
